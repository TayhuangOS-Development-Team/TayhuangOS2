...
/** 校验码 */
#define CHECKSUM -(MULTIBOOT2_HEADER_MAGIC + ARCHITECTURE + sizeof(struct TayhuangHeader))
 ...
 * 放在.multiboot段下
 */
struct TayhuangHeader TAYHUANG_HEADER
//将这个头放在.multiboot段下
...
= {
    ...
    .header = {
        ...
        .header_length = sizeof (struct TayhuangHeader),
        .checksum = CHECKSUM
    },
    //启用VBE
#ifdef VBE_ENABLE
